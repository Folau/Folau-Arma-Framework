...
// ====================================================================================
if (missionNamespace getVariable["f_param_debugMode",0] == 1) then { diag_log text "[F3] DEBUG (tfr_init.sqf): Executing Client Init."; };

private _grpBLU = []; private _grpOPF = []; private _grpIND = [];
...
} forEach (switch (playerSide) do { case west: {_grpBLU}; case east: {_grpOPF}; case independent: {_grpIND};});
