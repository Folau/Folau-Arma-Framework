...
private _ear = player createDiaryRecord ["diary", ["Ear Plugs", format["
	<br/><font size='18' color='#EA2E2E'>EAR PLUGS</font><br/>%1 in the mission by pressing <font color='#72E500'>%2</font color>.<br/><br/>When enabled, these will isolate ambient combat and vehicle sounds while leaving voice communications clear.",
