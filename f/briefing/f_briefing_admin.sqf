...
_missionZeus = _missionZeus + "<font size='18' color='#FF7F00'>Objects</font><br/>";
...
_missionZeus = _missionZeus + "<font size='18' color='#FF7F00'>Addons</font><br/>Do not use if 3rd Party Addons are running (ACE3 etc).<br/><br/>";
...
// SAFE START SECTION
_missionSafe = "<br/><font size='18' color='#FF7F00'>SAFE START CONTROL</font><br/><br/>
...
// DEBUG SECTION
_missionDebug = "<font size='18' color='#FF7F00'>DEBUG OPTIONS</font><br/><br/>
...
_missionEndings = "<font size='18' color='#FF7F00'>ENDINGS</font><br/><br/>These endings are available. To trigger an ending click on its link - It will take a few seconds to synchronise across all clients.<br/><br/>";
...
if (f_var_CustomNotes != "") then {
	_missionNotes = "<br/><font size='18' color='#FF7F00'>MISSION-MAKER NOTES</font><br/>";
...
_adminIntro ="<br/><font size='18' color='#FF7F00'>ADMIN SECTION</font><br/><br/>This briefing section can only be seen by server administrators.<br/><br/>";
