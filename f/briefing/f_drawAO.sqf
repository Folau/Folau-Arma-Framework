...
if (!hasInterface || !(_baseMarker in allMapMarkers)) exitWith {};
...
["prx_coverUp",(_coverSize * 2) + _baseSizeX, _coverSize, _baseMarkerPos vectorAdd [0, (_baseSizeY + _coverSize), 0]] call _makeBorder;
["prx_coverDn",(_coverSize * 2) + _baseSizeX, _coverSize, _baseMarkerPos vectorAdd [0, (_baseSizeY + _coverSize) * -1, 0]] call _makeBorder;
["prx_coverLt",_coverSize, _baseSizeY, _baseMarkerPos vectorAdd [(_baseSizeX + _coverSize), 0, 0]] call _makeBorder;
["prx_coverRt",_coverSize, _baseSizeY, _baseMarkerPos vectorAdd [(_baseSizeX + _coverSize) * -1, 0, 0]] call _makeBorder;
...
} forEach ["prx_coverUp","prx_coverDn","prx_coverLt","prx_coverRt"];
...
for "_i" from 0 to 270 step 90 do {
	...
	for "_m" from 0 to (count _colors - 1) do {
		private _marker = createMarkerLocal [format ["zone_%1_%2",_i,_m],_markerPos];
	...
	for "_m" from 0 to 7 do {
		private _marker = createMarkerLocal [format ["zoneBorder_%1_%2",_i,_m],_markerPos];
