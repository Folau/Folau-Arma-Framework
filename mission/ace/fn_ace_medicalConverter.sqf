...
if (missionNamespace getVariable["f_param_debugMode",0] == 1) then { diag_log text format ["[F3] DEBUG (ace_medicalConverter.sqf): Converting medical_level_%5 for %2 (%1 - F%3 M%4)",_unit, typeOf _unit, _cntFAK, _cntMediKit, ace_medical_level]; };
