...
_glsmokealt3 = "1Rnd_SmokeGreen_Grenade_shell";
_glsmokealt4 = "1Rnd_SmokeYellow_Grenade_shell";
...
_smokegrenadealt2 = "SmokeShellYellow";
_smokegrenadealt3 = "SmokeShellBlue";
_smokegrenadealt4 = "SmokeShellGreen";
...
{	
	...
	case "jtac":
	{
		...
		_unit addMagazines [_glsmokealt3,2];
		_unit addMagazines [_glsmokealt4,2];
		[_unit, _glrifle] call f_fnc_addWeapon;
		_unit addMagazines [_smokegrenade,2];
		_unit addMagazines [_smokegrenadealt,2];
		_unit addMagazines [_smokegrenadealt2,2];
		_unit addMagazines [_smokegrenadealt3,2];
		_unit addMagazines [_smokegrenadealt4,1];
		_unit addMagazines [_chem,1];
		_unit addMagazines [_pistolmag,2];
		[_unit, _pistol] call f_fnc_addWeapon;
